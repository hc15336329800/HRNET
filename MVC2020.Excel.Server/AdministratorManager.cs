...
namespace MVC2020.Excel.Server
{
    ...
    public class AdministratorManager : ModelBaseManager<Admin>
    {
        ...
        public string FindListcesi()
        {
            ...
            IQueryable<Admin> ik = base.Repository.FindList(Administrator => Administrator.AdministratorID > 0);
        ...
        {
            Response _resp = new Response();
            var _admin = FindNCount(administratorID);
            if (_admin == null)
            {
                _resp.Code = 0;
